...
import 'TaskList2.dart';

class TaskDetail3 extends StatefulWidget {
  // const TaskDetail({Key? key}) : super(key: key);
  @override
  State<TaskDetail3> createState() => _TaskDetailState3();
}

class _TaskDetailState3 extends State<TaskDetail3> {
  // 캘린더 관련 변수
  CalendarFormat _calendarFormat = CalendarFormat.month;
  DateTime _focusedDay = DateTime.utc(2022, 06, 09);
            ...
            children: <Widget>[
              ...
              OutlinedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TaskListGara()),
                  );
                },
                child: Text("CONFIRM"),
              ),
